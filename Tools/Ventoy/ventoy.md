...
Insert your USB stick/drive, click the refresh icon, select your drive, click install and let it do its thing. If you encounter any errors you might want to try to run the Ventoy GUI as root
